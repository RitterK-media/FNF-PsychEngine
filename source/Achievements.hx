...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		...
		["Best Teacher Ever",		    "Beat Week 1 on Hard with no Misses.",				'week1_nomiss',			false],
		["Shrine Power",				"Beat Week 2 on Hard with no Misses.",				'week2_nomiss',			false],
		["Relax Night",			        "Beat Week 3 on Hard with no Misses.",				'week3_nomiss',			false],
		...
		["Faster than light",			"Beat the \"Speed cop\" Stage.",	                'speed',				 true],
